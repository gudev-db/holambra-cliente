...
db_briefings = banco["briefings_Holambra"]  
                ...
                with st.spinner('Comparando com diretrizes da marca...'):
                    try:
                        ...
                        resposta = modelo_vision.generate_content([
                            ...
                            Regras específicas para Holambra:
                            - NÃO pode conter referências a flores Holambra
                            - Deve seguir a identidade visual da Holambra Cooperativa Agroindustrial
        ...
        if st.button("Validar Texto", key="validate_text"):
            with st.spinner('Verificando conformidade...'):
                resposta = modelo_texto.generate_content(
                    ...
                    Regras específicas para Holambra:
                    - NÃO pode conter referências a flores Holambra
                    - Deve seguir o tom de voz da Holambra Cooperativa Agroindustrial
...
with tab_briefing:
    ...
    db_briefings = client['briefings_Holambra']
    ...
    with tab_new:
        ...
        def criar_campo_selecionavel(rotulo, tipo="text_area", opcoes=None, padrao=None, key_suffix=""):
            ...
            if auto_preencher:
                ...
                prompt = f"Com base no seguinte contexto:\n{contexto}\n\n E o objetivo do briefing {objetivo_geral} \n\nPreencha o campo '{rotulo}' para um briefing do tipo {tipo_briefing} na Holambra Cooperativa Agroindustrial. Lembre-se: NÃO há conexão com flores Holambra. Retorne APENAS o valor para o campo, sem comentários ou formatação adicional."
        ...
        if st.button("🔄 Gerar Briefing Completo", type="primary"):
            with st.spinner('Construindo briefing profissional...'):
                try:
                    ...
                    prompt_parts = [
                        f"# BRIEFING {tipo_briefing.upper()} - Holambra Cooperativa Agroindustrial",
    ...
    with tab_saved:
        ...
        collection_briefings = client.briefings_Holambra.briefings
...
with tab_briefing_gerados:
    st.header("📚 Briefings Gerados - Holambra")
    st.markdown("---")
...
with tab_rewriter:
    st.header("Reescrever Conteúdo para a Holambra")
    st.caption("Cole um texto qualquer e o sistema irá reescrevê-lo seguindo as diretrizes da Holambra")
    ...
    with col_original:
        ...
        texto_original = st.text_area(
            ...
            height=400,
            placeholder="Insira aqui o texto que precisa ser adaptado para a Holambra...",
    ...
    with col_reescrito:
        st.subheader("Versão Holambra")
        
        if st.button("Reescrever Conteúdo", key="btn_reescrever"):
            if not texto_original.strip():
                st.warning("Por favor, insira um texto para reescrever")
            else:
                with st.spinner("Adaptando conteúdo para a Holambra..."):
                    try:
                        # Carrega as diretrizes atuais
                        diretrizes = collection_diretrizes.find_one({"marca": "Holambra"})
                        dos = "\n- ".join(diretrizes.get('dos', []))
                        donts = "\n- ".join(diretrizes.get('donts', []))
                        
                        prompt = f"""
                        Reescreva o seguinte conteúdo para ser publicado nos canais da Holambra Cooperativa Agroindustrial,
                        seguindo rigorosamente estas diretrizes da marca:
                        ...
                        - Manter o significado original mas adaptar ao estilo Holambra
                        - Priorizar clareza e objetividade
                        - Usar terminologia do agronegócio quando apropriado
                        - Seguir o manual de identidade visual da Holambra
                        ...
                        st.download_button(
                            ...
                            data=resposta.text,
                            file_name="conteudo_adaptado_holambra.txt",
                            mime="text/plain"
                        )
...
with tab_diretrizes:
    ...
    db_diretrizes = client['holambra_diretrizes']
    collection_diretrizes = db_diretrizes['dos_and_donts']
    
    # Carrega as diretrizes existentes
    diretrizes_existentes = collection_diretrizes.find_one({"marca": "Holambra"})
    ...
    if not diretrizes_existentes:
        ...
        collection_diretrizes.insert_one({
            "marca": "Holambra",
            "dos": [
                "Seguir o manual de identidade visual", 
                "Usar tom de voz profissional",
                "Manter foco no agronegócio",
                "Referenciar sempre como 'Holambra Cooperativa Agroindustrial'"
            ],
            "donts": [
                "Usar cores fora da paleta", 
                "Modificar o logo",
                "Fazer referência a flores Holambra",
                "Associar com a cidade Holambra"
            ],
